...
const Borrow = () => {
    const lendData = [
        { title: 'Total Deposits', amount: '$16.549' },
        { title: 'Earning APY%', amount: '3.3%', color: 'rgba(35, 227, 62, 1)' },
        { title: 'Interest Earned', amount: '$1,068' },
    ];
    const borrowData = [
        { token: 'Ethereum', symbol: 'ETH', available: '15.04', liquidity: '48.0545', totalAPY: '2.16%%', image: '/images/Ethereum.png', Btn: "Enable" },
